...
//This is similar to the code we wrote in extentreports/TestCase1.java. It's a cleaner version of the methods: -- 
// Instead of adding the extentreports code to every test case, you instead can add it once, as below, and then add it to your testng.xml file in the listener section:
//<listener class-name="extentlisteners.ExtentListeners" />


//You could add the below code (but correct the screenshotutil issue below) and then add it to your testng.xml file as a listener -- then you don't need to set it up in each file. -- This file along with the ExtentManager act as a library you can copy/paste into projects.
